...
public class RouteController {
    ...
    public ResponseEntity<List<Node>> getRoute(
        ...
        Node startNode = routeService.findNearestNode(fromLat, fromLon);
        Node endNode = routeService.findNearestNode(toLat, toLon);
        List<Node> path = routeService.findShortestRoute(startNode.getId(), endNode.getId(), routeType);
